...
const Sidebar = ({page}) => {
 ...
 <div>
    ...
    {/* steps */}
    <div id="sidebar" className="flex flex-col bg-[#43215D] pt-6 pr-4 pb-0 pl-10 fixed">
      ...
      <li className='relative flex mb-[1.4rem]' key={index}>
        <div>
          <button
            ...
            className={
             `${page === index
                ? 'bg-green-500 rounded-full px-2 text-white'
                : ''} ${page > index ? 'bg-green-500 rounded-full px-2 text-white' : ''} filter-btn step text-white hover:bg-white hover:text-black rounded-full w-8 h-8 px-0.5 border-2 bg-transparent
            `}
            data-id="1"
          >
        ...
        <div className="flex justify-between mb-[50px] text-[#BFBFBF] text-xs font-light ">
        ...
        {/* <img src={circle} alt="" className='pt-[-500px]'/>
        <div className="flex justify-between pt-[-500px] text-[#BFBFBF] text-xs font-light ">
            <p className="pr-28">Skillpaddy Job Match</p>
            <p className="flex mr-2"><img src={mail} alt="" className="pr-2"/> help@skillpaddy.com</p>
        </div> */}
    </div>
